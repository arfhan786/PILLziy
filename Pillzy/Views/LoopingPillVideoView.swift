...
final class PillVideoUIView: UIView {
    ...
    func setupPlayer() {
        guard let url = Bundle.main.url(forResource: "Pill-video 2", withExtension: "MP4", subdirectory: "Resources")
            ?? Bundle.main.url(forResource: "Pill-video 2", withExtension: "MP4") else {
            return
        }
